...
namespace Abstraction_VroomVroom
{
    public class Submarine : IDriveable, ISubmersible
    {
        ...
        public void ChangeDirection(int degrees)
        {
            ...
            {
                Console.WriteLine($"Turning the jet ski to the right {degrees - 45} degrees.");
            }
            else if (degrees < 45)
            {
                Console.WriteLine($"Turning the jet ski to the left {45 - degrees} degrees.");
            }
            else if (degrees == 45)
            {
            ...
            {
                Console.WriteLine("Invalid input. That's not how jet ski handles work.");
            }
