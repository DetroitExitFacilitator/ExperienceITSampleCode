...
namespace Encapsulation_External
{
    public class ExternalHacker
    {
        public static void TryToStealInfo()
        {
            ...
            Console.WriteLine("Cannot access PrivateHuman's SSN because only SecureHuman can see the SSN.");
            Console.WriteLine();
